    ...
    fields: () => ({
        ...
        company: {
            ...
            resolve: (parentValue, args) => {
                ...
                return axios.get(`http://localhost:3000/companies/${companyId}`).then((response) => response.data)
            }
        }
    })
})
    ...
    fields: {
        addUser: {
            ...
            resolve: (parentValue, args) => {
                ...
                return axios.post(`http://localhost:3000/users`, { firstName, age }).then((response) => response.data)
            }
        },
        deleteUser: {
            type: UserType,
